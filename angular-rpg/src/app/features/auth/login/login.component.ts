...
@Component({
  ...
  template: `
    <div class="min-h-screen flex items-center justify-center bg-rpg-bg px-4">
      ...
      <div class="relative w-full max-w-md">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-rpg-muted mt-2 text-sm">
            Accede a tu cuenta de aventurero
          </p>
        </div>
        ...
        <div class="rpg-card shadow-gold-lg">
          ...
          <p class="text-center text-rpg-muted text-sm mt-5">
            ¿No tienes cuenta?
            <a routerLink="/register" class="text-rpg-gold hover:underline ml-1">
              Regístrate aquí
            </a>
          </p>
        </div>
